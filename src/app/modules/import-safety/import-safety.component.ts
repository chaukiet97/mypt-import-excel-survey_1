...
@Component({
  selector: 'app-import-safety',
  templateUrl: './import-safety.component.html',
  styleUrls: ['./import-safety.component.scss'],
  providers: [
...
export class ImportSafetyComponent implements OnInit {
